  ...
  return (
    <div className="py-8 flex flex-col gap-5 text-center">
      ...
      <div className="container m-2 space-y-6 text-left">
        <p className="font-bold">Last updated: February 18, 2024</p>
        <p>
          The Privacy Policy describes Our policies and procedures on the
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to MealMates.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Maldives
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to MealMates, accessible from{" "}
              <a
                href="www.mealmates.com"
        ...
        <ul>
          <li>By email: hello@mealmates.com</li>
        </ul>
      </div>
    </div>
  );
